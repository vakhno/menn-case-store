...
const Steps = (props: Props) => {
	...
	return (
		<ol className="rounded-md bg-white lg:flex lg:rouned-none lg:border-l lg:border-r lg:border-gray-200">
						...
						<div>
							...
							<span
								...
								<span className="ml-4 h-full mt-0.5 flex min-w-0 flex-col justify-center">
									...
									<span className="text-sm text-zinc-500">{step.desciption}</span>
								</span>
							</span>
							{index !== 0 ? (
